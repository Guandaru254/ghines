// src/api/team.js
// -----------------------------------------------------------------------------
// The Ghines Foundation – Board of Directors & Team Data
// -----------------------------------------------------------------------------
// IMPORTANT:
// - This file MUST remain pure ESM
// - Do NOT add module.exports or exports.*
// - Safe for Next.js 14 static generation
// -----------------------------------------------------------------------------
...
const Team = [
  {
    ...
    snippet:
      "George N. Ghines, 58, is a South Sudan–born entrepreneur with more than three decades of leadership experience across Africa, the Middle East, and the Balkans.",
  ...
  },
  {
    ...
    snippet:
      "George A. Miriyannis is an ambassador with a long and distinguished career in international affairs, media, and cultural relations.",
...
Respected for his calm leadership and sharp understanding of global affairs, Mr Miriyannis brings to the Ghines Foundation a broad international outlook and decades of experience connecting people and ideas across continents.`,
  },
  {
    id: "3",
    ...
    snippet:
      "Jawahir Yusuf Haji Adam is a Somali diplomat and humanitarian with extensive experience in refugee affairs.",
